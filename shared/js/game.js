...
function openHostPeer(){
    ...
    var peer = new Peer(id.toString(), {host: 'https://peer-app.herokuapp.com', path: '/'}, {secure: true} );
    success('Peer-id = ' + id);
    isHost = true;
...
function connectToPeer(){
    ...
    var peer = new Peer(id, {host: 'https://peer-app.herokuapp.com', path: '/'}, {secure: true} );
