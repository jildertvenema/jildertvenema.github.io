...
function openHostPeer(){
    ...
    var peer = new Peer(id.toString(), {host: 'peer-app.herokuapp.com', secure:true, port:443, key: 'peerjs'}, {secure: true} );
    success('Peer-id = ' + id);
    isHost = true;
...
function connectToPeer(){
    ...
    var peer = new Peer(id, {host: 'peer-app.herokuapp.com', secure:true, port:443, key: 'peerjs'}, {secure: true} );
