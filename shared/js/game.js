...
function openHostPeer(){
    ...
    var peer = new Peer(id.toString(), {host: 'peer-app.herokuapp.com', path: '/app', port: 20258}, {secure: true} );
    success('Peer-id = ' + id);
    isHost = true;
...
function connectToPeer(){
    ...
    var peer = new Peer(id, {host: 'peer-app.herokuapp.com', port: 20258, path: '/app'}, {secure: true} );
