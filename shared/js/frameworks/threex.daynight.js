...
THREEx.DayNight.StarField	= function(){
	// create the mesh
	var texture = new THREE.TextureLoader().load( "shared/images/galaxy_starfield.png" );
	...
	var geometry	= new THREE.SphereGeometry(10000, 80, 80);
...
THREEx.DayNight.SunSphere	= function(){
	...
	this.update	= function(sunAngle){
		mesh.position.x = 0;
		mesh.position.y = Math.sin(sunAngle) * 50000;
		mesh.position.z = Math.cos(sunAngle) * 50000;
